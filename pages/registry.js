...
export default function Registry() {
  ...
  return (
    <div className="flex flex-col px-4 min-h-screen pt-10 sm:pt-24 lg:pt-0  justify-center space-y-12 lg:space-y-0  w-screen  lg:flex-row ">
      ...
      <div className="lg:max-w-screen lg:flex lg:flex-1 lg:pl-72 lg:justify-center lg:items-center lg:mx-auto ">
