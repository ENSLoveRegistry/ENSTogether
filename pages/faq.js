          ...
          {({ open }) => (
            <>
              ...
              <Disclosure.Panel className="px-4 pt-4 pb-2 text-md text-rose-700">
                ...
                experiment that seeks to extrapolate some features of the
          ...
          {({ open }) => (
            <>
              ...
              <Disclosure.Panel className="px-4 pt-4 pb-2 text-md text-rose-700">
                ...
                Jokes aside, there are two reasons behind this decision: <br />
                Avoid spam registrations and ensure true intention and
                commitment, since an address can only be registered once. <br />
                <span className="text-sm">
                  * Unless the register modified or canceled. See section below.
                </span>
              </Disclosure.Panel>
            </>
          )}
          ...
          {({ open }) => (
            <>
              ...
              <Disclosure.Panel className="px-4 pt-4 pb-2 text-md text-rose-700">
                ...
                expires the proposer is allowed to propose again in the future.
              </Disclosure.Panel>
            </>
          )}
        </Disclosure>
